          ...
          <div className="col-lg-7 col-md-7 col-sm-12 col-12" data-aos="fade-up" data-aos-delay="200" data-aos-once="true">
            <div className="section1__content">
              ...
              <div>
                ...
                <a href="https://drive.google.com/uc?export=download&id=1O7lNFbKdeOOpVos0jSUchLwIguSVwvRU" download className="section1__downloadcvbtn" ><span>Download CV</span></a>
              </div>
            </div>
          </div>
